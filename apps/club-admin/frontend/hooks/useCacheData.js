...
const useCacheData = () => {
  ...
  useEffect(() => {
    ...
    // DESABILITADO COMPLETAMENTE para resolver o problema de consultas excessivas
    // console.log(`🚫 [CacheData] Polling completamente desabilitado - era executado a cada ${refreshInterval/60000} minutos`);
