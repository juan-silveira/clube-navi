...
// import useBalanceSync from "@/hooks/useBalanceSync"; // DESABILITADO
...
const DashboardContent = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (showLoginSuccess && loginUserName) {
      showSuccess(t('login.welcome', { name: loginUserName }), t('login.success'));
  ...
  // const balanceSyncHook = useBalanceSync(); // DESABILITADO
  // const { isActive, startSync } = balanceSyncHook || {}; // DESABILITADO
  
  // Removido o hook de título do layout principal para permitir que páginas específicas controlem seus títulos
  
  // DESABILITADO - Iniciar sincronização de balance automaticamente 
  // useEffect(() => {
          ...
          <NotificationProvider>
            ...
            >
              ...
              <div
                ...
                } ${navbarType === "sticky" || navbarType === "floating" ? "pt-20" : ""}`}
              >
