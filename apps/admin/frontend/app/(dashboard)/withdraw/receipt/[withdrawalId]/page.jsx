...
const WithdrawReceiptPage = () => {
  ...
  const formatPixKeyType = (pixKeyType) => {
    if (!pixKeyType) return 'CPF'; // Default to CPF

    const type = pixKeyType.toUpperCase();
    const pixKeyTypes = {
      'CPF': 'CPF',
      'CNPJ': 'CNPJ',
      'EMAIL': 'Email',
      ...
      'UNKNOWN': 'CPF' // Default fallback
    };

    return pixKeyTypes[type] || 'CPF';
  };
