...
const CryptoTab = () => {
  ...
  const products = [
    {
      icon: 'BTC.png',
      name: t('crypto.products.bitcoinFuture'),
      code: 'BTC',
      price: 'R$ 100.000,00',
      profitability: t('crypto.products.bitcoinProfitability'),
      profitabilityClass: 'text-green-600',
      payment: t('crypto.products.monthly'),
      daysRemaining: t('crypto.products.daysRemaining', { days: 100 }),
      market: t('crypto.products.primaryMarket'),
    },
  ];
            ...
            <thead className="bg-gray-50 dark:bg-gray-900">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.asset')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.price')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.profitability')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.payment')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.daysRemaining')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.market')}
                </th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  {t('crypto.table.actions')}
                </th>
              </tr>
            </thead>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200">
              {t('crypto.infoCard.title')}
            </h3>
            <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
              <p>
                {t('crypto.infoCard.description')}
              </p>
            </div>
          </div>
        </div>
