                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="block text-sm">{t('profile.menu.notificationSound')}</span>
                    </div>
                    <Switch
                      value={soundEnabled}
              ...
              {({ active }) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="block text-sm">{t('profile.menu.profile')}</span>
                  </div>
                </button>
              )}
            </Menu.Item>
              ...
              {({ active }) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="block text-sm">{t('mobileFooter.settings')}</span>
                  </div>
                </button>
              )}
            </Menu.Item> */}
              ...
              {({ active }) => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="block text-sm">{t('profile.menu.logout')}</span>
                  </div>
                </button>
              )}
            </Menu.Item>
