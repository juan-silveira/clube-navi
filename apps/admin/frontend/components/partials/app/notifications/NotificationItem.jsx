    ...
    <li className="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-3 group cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/50 relative min-h-[60px]">
      ...
      >
        ...
        >
          ...
          <Tooltip placement="top" arrow content={isRead ? t('item.tooltips.markAsUnread') : t('item.tooltips.markAsRead')}>
            <button
              onClick={(e) => {
                e.stopPropagation();
                if (isRead) {
          ...
          {onRestore ? (
            <Tooltip placement="top" arrow content={t('item.tooltips.restore')}>
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  onRestore(id);
            ...
            <Tooltip placement="top" arrow content={t('item.tooltips.delete')}>
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  onDelete(id);
