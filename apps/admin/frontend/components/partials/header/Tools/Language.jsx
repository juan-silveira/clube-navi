...
const languages = [
  ...
  // { name: "Français", icon: "circle-flags:fr", code: "fr" },
  // { name: "Deutsch", icon: "circle-flags:de", code: "de" },
  // { name: "Italiano", icon: "circle-flags:it", code: "it" },
  // { name: "日本語", icon: "circle-flags:jp", code: "ja" },
  // { name: "한국어", icon: "circle-flags:kr", code: "ko" },
  // { name: "中文", icon: "circle-flags:cn", code: "zh" },
];
