        ...
        <table className="w-full border-collapse dark:border-slate-700 dark:border">
          <thead>
            <tr className="bg-slate-50 dark:bg-slate-700">
              <th className="w-16 md:w-20 text-xs font-medium leading-4 uppercase text-slate-600 dark:text-slate-300 ltr:text-left ltr:last:text-right rtl:text-right rtl:last:text-left">
                <span className="block px-3 md:px-6 py-5 font-semibold">{t('balances.table.logo')}</span>
              </th>
              <th className="w-20 md:w-24 text-xs font-medium leading-4 uppercase text-slate-600 dark:text-slate-300 ltr:text-left ltr:last:text-right rtl:text-right rtl:last:text-left">
                <span className="block px-3 md:px-6 py-5 font-semibold">{t('balances.table.symbol')}</span>
              </th>
              <th className="min-w-0 flex-1 text-xs font-medium leading-4 uppercase text-slate-600 dark:text-slate-300 ltr:text-left ltr:last:text-right rtl:text-right rtl:last:text-left">
                <span className="block px-3 md:px-6 py-5 font-semibold">{t('balances.table.name')}</span>
              </th>
              <th className="w-24 md:w-32 text-xs font-medium leading-4 uppercase text-slate-600 dark:text-slate-300 ltr:text-left ltr:last:text-right rtl:text-right rtl:last:text-left">
                <span className="block px-3 md:px-6 py-5 font-semibold">{t('balances.table.balance')}</span>
              </th>
            </tr>
          </thead>
          <tbody>
