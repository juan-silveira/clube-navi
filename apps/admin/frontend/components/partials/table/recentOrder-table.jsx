...
import { recentOrder } from '@/constants/table-data';
...
const RecentOrderTable = () => {
  ...
  const COLUMNS_TRANSLATED = useMemo(() => [
    {
      Header: t('recentTrades.user'),
      accessor: "user",
      Cell: (row) => {
        return (
          <div>
  ...
  const columns = useMemo(() => COLUMNS_TRANSLATED, [COLUMNS_TRANSLATED]);
