...
/**
 * @swagger
 * /api/transactions/available-tokens:
 *   get:
 *     summary: Obtém tokens disponíveis no banco de dados
 *     tags: [Transactions]
 *     security:
 *       - BearerAuth: []
 *     responses:
 *       200:
 *         description: Tokens disponíveis obtidos com sucesso
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 */
router.get('/available-tokens', transactionController.getAvailableTokens);
 ...
 *   get:
 *     summary: Obtém todas as transações de uma empresa (para admins)
 *     tags: [Transactions]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Transações da empresa obtidas com sucesso
 *       401:
 *         description: Não autorizado
 */
router.get('/company', authenticateToken, transactionController.getCompanyTransactions);
