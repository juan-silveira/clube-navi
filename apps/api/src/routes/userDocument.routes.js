 ...
 */
router.post('/:documentType/upload', (req, res, next) => {
...
}, userDocumentController.uploadUserDocument);
 ...
 *   get:
 *     summary: Busca documentos de um usuário específico (admin)
 *     tags: [User Documents]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 */
router.get('/user/:userId', requireAnyAdmin, userDocumentController.getUserDocuments);

/**
 * @swagger
 * /api/user-documents/admin/{documentId}:
 *   get:
 *     summary: Busca documento por ID (admin)
 *     tags: [User Documents]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *         description: Documento não encontrado
 */
router.get('/admin/:documentId', requireAnyAdmin, userDocumentController.getDocumentById);
