...
/**
 * @swagger
 * /api/2fa/admin/{userId}/status:
 *   get:
 *     summary: Obtém status 2FA de um usuário (admin)
 *     tags: [Two Factor Authentication - Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Status 2FA do usuário
 *       401:
 *         description: Token inválido
 *       403:
 *         description: Acesso negado
 */
router.get('/admin/:userId/status', requireAnyAdmin, twoFactorController.get2FAStatusByAdmin);

/**
 * @swagger
 * /api/2fa/admin/{userId}/disable:
 *   post:
 *     summary: Desabilita 2FA de um usuário (admin)
 *     tags: [Two Factor Authentication - Admin]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: Acesso negado
 */
router.post('/admin/:userId/disable', requireAnyAdmin, twoFactorController.disable2FAByAdmin);
