    ...
    const contentTemplates = {
      ...
      password_reset: `
        <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          <h2 style="color: #333; margin-top: 0;">Redefinição de senha - {{companyName}}</h2>
        </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="{{resetUrl}}" class="button" style="background: #10b981; color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 500; font-size: 16px;">
            Redefinir Senha
          </a>
        </div>
        ...
        <p style="font-size: 14px; color: #999; line-height: 1.6;">
          Se você não solicitou esta redefinição, por favor ignore este email. Sua senha permanecerá inalterada.
        </p>
