...
const defaultTokens = [
  ...
  // cBRL - Token ERC20 da Testnet
  {
    ...
    metadata: {
      ...
      website: 'https://',
      explorer: process.env.TESTNET_EXPLORER_URL || 'https://floripa.azorescan.com/',
      isNative: false
    },
    abi: getTokenABI()
  },
  ...
  // cBRL - Token ERC20 da Mainnet (placeholder)
  {
    ...
    metadata: {
      ...
      website: 'https://',
      explorer: process.env.MAINNET_EXPLORER_URL || 'https://azorescan.com/',
      isNative: false
    },
    abi: getTokenABI()
  },
  ...
  // cBRL - Token ERC20 da Mainnet
  {
    ...
    metadata: {
      ...
      logo: 'https://coinage.trade/logo-cbrl.png',
      isMainnetToken: true,
      isNative: false
    },
    abi: getTokenABI() // Usa TOKEN_ABI para funções ERC20 como balanceOf
