...
class RabbitMQConfig {
  ...
  /**
   * Publica uma solicitação de matching de ordens
   */
  ...
  /**
   * Publica uma solicitação para executar match na blockchain
   */
  ...
  /**
   * Publica atualização para broadcast via WebSocket
   */
